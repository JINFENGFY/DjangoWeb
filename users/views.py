...
class UserHome (View):
    def get(self, request, user_id, page_num):
        ...
        years = int ((datetime.now ().replace (
            tzinfo=pytz.timezone ('UTC')) - user_info.usercreated).total_seconds () / 86400 + 1)
        content={'user_page': user_page,
                 'user_info': user_info,
                 'years': years,
        ...
        return render (request, 'user_home_page.html',content)
